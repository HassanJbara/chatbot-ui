...
<template>
  <div
    class="bg-gray-50 dark:bg-black p-10 flex items-center justify-center w-full h-screen"
  >
    <h1 class="absolute top-4 text-3xl font-bold">Tweet Demo</h1>

    <div
      class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl"
    >
      <div class="flex justify-between">
        <div class="flex items-center">
          <img class="h-11 w-11 rounded-full" src="/images/x-logo.jpeg" />
      ...
      <div
        tabindex="0"
        class="collapse collapse-arrow mt-2 bg-[#d64933] overflow-visible"
      >
        <div
          class="collapse-title flex flex-row items-center gap-2 overflow-visible text-white"
        >
          <inline-svg src="/icons/cross.svg" class="h-5 w-5" />
      ...
      <div class="text-gray-500 dark:text-gray-400 flex mt-3">
        <div class="flex items-center mr-6">
          <svg class="fill-current h-5 w-auto" viewBox="0 0 24 24" style="">
            <g>
              <path
